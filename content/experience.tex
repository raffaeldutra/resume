...
\def\experienceFourAll{
  ...
  {%
    ...
    {Kubernetes clusters (EKS) management and new implementations}
  },
  {%
    \IfLanguageName{portuguese}%
  ...
  {%
    ...
    {Active communication with development times for new projects}
  },
  {%
    \IfLanguageName{portuguese}%
    {Automações para Operações em Plataforma em nível de Pipelines desenvolvidas em Shell Script e Python}
    {Automations for Operations in our platform using Piplines coded in Shell Script and Python}
  },
  {%
    \IfLanguageName{portuguese}%
