...
\def\experienceLiberCapital{
  ...
  {%
    \IfLanguageName{portuguese}%
    {%
      Ansible para gerência de configuração.
      \newline
      Projetos internos dos mais diversos para automação usando Ansible juntamente com Azure DevOps.
    }
    {%
      Configuration Management using Ansible.
      \newline
      Multiple internal projecs automated using Ansible with Azure DevOps.
    }
  }
}
